...
export function AssessmentComponent() {
  ...
  const [newStep, setNewStep] = useState<Step>({
    ...
    title: "",
    description: "",
  }); // Specify the type for newStep
  const [skills, setSkills] = useState<string[]>([]);
  const [currentSkill, setCurrentSkill] = useState<string>("");
  const [isEditing, setIsEditing] = useState<boolean>(false);

  const initialSteps: Step[] = [
    // Specify the type for initialSteps
    {
      id: "1",
  ...
  const assessmentTypes = [
    {
      ...
      description:
        "Screening questions to assess candidates' suitability for the job.",
    },
    {
      label: "Aptitude Test",
      value: "aptitude_test",
      description:
        "Questions to evaluate candidates' basic skills and abilities.",
    },
    {
      label: "Technical Test",
      value: "technical_test",
      description:
        "Questions to evaluate candidates' technical skills and knowledge.",
    },
    {
      label: "Interview",
      value: "interview",
              ...
              >
                {
                  assessmentTypes.find(
                    (type) => type.value === step.assessmentType
                  )?.description
                }
              </Text>
            </Flex>
        ...
        <Dialog open={isModalOpen}>
          <DialogContent
            css={{
              ...
              height:
                newStep.assessmentType === "aptitude_test" ||
                newStep.assessmentType === "technical_test"
                  ? "620px"
                  : "480px",
              borderRadius: "$xl",
              display: "flex",
          ...
          >
            ...
            >
              ...
              >
                {isEditing ? "Edit Assessment Step" : "Add New Assessment Step"}
              </Text>
                ...
                <Flex flexDirection="column" gap="$2">
                  ...
                  <Select
                    ...
                    value={assessmentTypes.find(
                      (type) => type.value === newStep.assessmentType
                    )}
                    size="lg"
                    css={{
